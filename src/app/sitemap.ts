...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const core = [
    ...
    { url: '/ut-austin-computer-science-salary',      p: 0.9,  cf: 'monthly' as const },
    { url: '/ut-austin-mccombs-salary',               p: 0.9,  cf: 'monthly' as const },
    { url: '/ut-austin-engineering-salary',           p: 0.9,  cf: 'monthly' as const },
    { url: '/what-is-ut-austin-known-for',            p: 0.9,  cf: 'monthly' as const },
    { url: '/is-ut-austin-a-good-school',             p: 0.9,  cf: 'monthly' as const },
    { url: '/hyde-park-condo-guide-ut-austin',        p: 0.9,  cf: 'monthly' as const },
    { url: '/ut-austin-tuition-history',              p: 0.85, cf: 'monthly' as const },
    { url: '/ut-austin-vs-community-college-transfer', p: 0.9, cf: 'monthly' as const },
    { url: '/west-campus-vs-hyde-park',               p: 0.9,  cf: 'monthly' as const },
    { url: '/ut-austin-family-weekend-guide',         p: 0.85, cf: 'monthly' as const },
    { url: '/ut-austin-study-abroad-programs',        p: 0.85, cf: 'monthly' as const },
    { url: '/second-sibling-ut-austin-residency-pathway', p: 0.9, cf: 'monthly' as const },
    { url: '/ut-austin-campus-visit-guide',           p: 0.85, cf: 'monthly' as const },
    { url: '/ut-austin-undergraduate-research-opportunities', p: 0.85, cf: 'monthly' as const },
    { url: '/ut-austin-nursing-school',               p: 0.9,  cf: 'monthly' as const },
    { url: '/ut-austin-architecture-school',          p: 0.9,  cf: 'monthly' as const },
    { url: '/ut-austin-butler-music-school',          p: 0.85, cf: 'monthly' as const },
    { url: '/ut-austin-graduation-rate-retention',    p: 0.9,  cf: 'monthly' as const },
    { url: '/ut-austin-payment-plan-tuition-installment', p: 0.85, cf: 'monthly' as const },
    { url: '/best-austin-neighborhoods-for-ut-students', p: 0.9, cf: 'monthly' as const },
    { url: '/ut-austin-waitlist-what-to-know',        p: 0.9,  cf: 'monthly' as const },
    { url: '/ut-austin-double-major-guide',           p: 0.85, cf: 'monthly' as const },
